    ...
    <div class="col-md-12">
        <div class="box box-primary">
            <div class="box-header with-border">
                ...
                <div class="box-tools">
                    <form name="pencarianrawatjalan" action="<?= base_url('sinchan/evaluasiKaru'); ?>" method="POST">
                        <div class="col-xs-10 pull-right">
                            <div class="input-group input-group-sm">

                                <!-- <select class="form-control form-control-sm pull-right" id="cari_status" name="cari_status">
                                    <option value=""> -- Status Verif --</option>
                                ...
                                <select class="form-control form-control-sm pull-right" id="cari_bawahan" name="cari_bawahan">
                                    <option value=""> -- Bawahan --</option>
                                    <?php if (!empty($bawahan)) : ?>
                                        <?php foreach ($bawahan as $cb) : ?>
                                            <option value="<?= $cb['user_id']; ?>" <?= set_select('cari_bawahan', $cb['user_id']); ?>><?= $cb['pd_nickname']; ?></option>
                                        <?php endforeach ?>
                                    <?php endif ?>
                                </select>
...
<div class="modal fade" id="submenumodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="<?= base_url('sinchan/konfirmasievaluasiKaru'); ?>" method="post">
