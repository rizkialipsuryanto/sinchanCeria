  ...
  <div class="wrapper">
    ...
    <header class="main-header">
      ...
      <a href="<?= base_url('user'); ?>" class="logo">
        ...
        <span class="logo-mini"><b>SINCHAN</b></span>
        <!-- logo for regular state and mobile devices -->
        <span class="logo-lg"><b>SINCHAN </b>CERIA</span>
      </a>
      ...
      <nav class="navbar navbar-static-top">
        ...
        <a class="sidebar-toggle" data-toggle="push-menu" role="button">
          ...
          &nbsp; <b style="font-style:normal;font-family:Arial" id="timer"></b>
        </a>
          ...
          <ul class="nav navbar-nav">
            ...
            <li class="dropdown user user-menu">
              <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                ...
                <span class="hidden-xs"><?= $user['pd_nickname']; ?> <?= $user['lastname']; ?></span>
              </a>
              <ul class="dropdown-menu">
                ...
                <li class="user-header">
                  ...
                  <p>
                    <?= $user['pd_nickname']; ?> <?= $user['lastname']; ?>
